...
import evidenceRoute from "./routes/user/evidence";
import carouselsRoute from "./routes/user/carousels";
...
userApp.route("/api/carousels", carouselsRoute);
userApp.route("/api/evidence", evidenceRoute);
userApp.route("/api/publish", publishRoute);
userApp.route("/api/topics", topicsRoute);
userApp.route("/api/products", productsRoute);
